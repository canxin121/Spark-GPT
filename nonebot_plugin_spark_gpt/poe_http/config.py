...
class PoeTemper(BaseModel):
    ...
    base_botinfo_dict: dict[str, BotInfo] = {
        ...
        "psc": BotInfo(
            truename="a2", nickname="Claude-instant", owner="_every_one_", num_users=0
        ),
        "pss": BotInfo(
            truename="capybara", nickname="Sage", owner="_every_one_", num_users=0
        ),
        "psd": BotInfo(
            truename="nutria", nickname="Dragonfly", owner="_every_one_", num_users=0
        ),
        "psn": BotInfo(
            truename="hutia", nickname="Neevaai", owner="_every_one_", num_users=0
        ),
    }

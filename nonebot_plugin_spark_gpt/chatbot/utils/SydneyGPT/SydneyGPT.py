...
try:
    from ..EdgeGPT.EdgeGPT import ChatHubRequest, Chatbot as EdgeChatBot, ChatHub, \
        ConversationStyle as EdgeConversationStyle
except ImportError:
    from ..EdgeGPT import _ChatHubRequest as ChatHubRequest, Chatbot as EdgeChatBot, _ChatHub as ChatHub, \
        ConversationStyle as EdgeConversationStyle

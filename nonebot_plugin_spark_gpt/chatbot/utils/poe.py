...
class Client:
    ...
    def on_message(self, ws, msg):
        try:
            ...
            for message_str in data["messages"]:
                ...
                if "suggestedReplies" in message and type(message["suggestedReplies"]) == list and len(
                        message["suggestedReplies"]) > 0 and message["messageId"] in self.suggestion_callbacks:
    ...
    def edit_bot(self, handle, prompt, old_handle=None, bot_id=None, display_name=None, base_model="chinchilla",
                 description="",
